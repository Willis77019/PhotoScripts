 ...
 "cells": [
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "--- MODE: AUTO-DETECT via TIMESTAMP ---\n",
      "Found 9 panoramas to stitch.\n",
      "Processing Pano 1...\n",
      "    -> Processing Pano: DSC_0629 (51 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n",
      "Processing Pano 2...\n",
      "    -> Processing Pano: DSC_0680 (69 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n",
      "Processing Pano 3...\n",
      "    -> Processing Pano: DSC_0749 (46 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n",
      "Processing Pano 4...\n",
      "    -> Processing Pano: DSC_0795 (78 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [WARNING] No output found. Log: enblend: warning: images do not overlap; they will be combined without blending\n",
      "enblend: note: usually this means that at least one of these images does not\n",
      "enblend: note: belong to the set or the ord\n",
      "Processing Pano 5...\n",
      "    -> Processing Pano: DSC_0873 (46 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n",
      "Processing Pano 6...\n",
      "    -> Processing Pano: DSC_0919 (16 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n",
      "Processing Pano 7...\n",
      "    -> Processing Pano: DSC_0938 (12 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n",
      "Processing Pano 8...\n",
      "    -> Processing Pano: DSC_0951 (11 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n",
      "Processing Pano 9...\n",
      "    -> Processing Pano: DSC_0963 (30 images)\n",
      "      -> Finding Control Points...\n",
      "      -> Optimizing Geometry...\n",
      "      -> Rendering...\n",
      "      [DONE] Saved 1 file(s).\n"
   ...
   "source": [
    ...
    "-------------------------------------------------------------------------------\n",
    "Author:       Brian Willis (programmed to a large extent by Gemini AI)\n",
